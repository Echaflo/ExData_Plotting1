...
## es el acomodo de la graficas en el grid
## is the arrangement of the graphics in the grid
...
plot(HPC_power[, dateTime], HPC_power[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

## Plot 2
## now the graph with the information of the information subset is created.
## ahora se creal el grafico con la informacion del subconjunto de informacion.
plot(HPC_power[, dateTime],HPC_power[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
## now the graph with the information of the information subset is created.
## ahora se creal el grafico con la informacion del subconjunto de informacion.
plot(HPC_power[, dateTime], HPC_power[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
